...
import '../../models/vendor.dart'; // Assuming a Vendor model exists
import '../../models/request.dart';
import '../../services/request.dart';

class VendorActionDataCell extends StatefulWidget {
  ...
  final Function(Vendor) showLedger;
  final Vendor vendor;

  VendorActionDataCell({
  ...
  @override
  _VendorActionDataCellState createState() => _VendorActionDataCellState();
}

class _VendorActionDataCellState extends State<VendorActionDataCell> {
      ...
      bool? shouldSendRequest = await showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text("Do you want to send a request for editing or deleting this vendor?"),
            actions: [
              TextButton(
                onPressed: () {
      ...
      children: [
        Tooltip(
          ...
          child: IconButton(
            ...
            onPressed: () => widget.onEdit(widget.vendor),
          ),
        ),
        Tooltip(
          ...
          child: IconButton(
            ...
            onPressed: () => widget.onDelete(widget.vendor.id),
          ),
        ),
        Tooltip(
          message: 'View Ledger',
          child: IconButton(
            ...
            onPressed: () => widget.showLedger(widget.vendor),
          ),
        ),
      ],
    );
      ...
      children: [
        ...
        Tooltip(
          ...
          child: IconButton(
            ...
            onPressed: () => createRequestOnAction(context, widget.employeeId, widget.documentType, widget.vendor.id),
          ),
        ),
      ],
    );
