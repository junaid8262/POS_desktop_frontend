...
class VendorBillActionDataCell extends StatefulWidget {
  final Future<Request?> futureRequest;
  final String employeeId;
  final String documentType;
  final String documentId;
  final String userRole;
  final Function(VendorBill) onEdit;
  final Function(String) onDelete;
  final Function(VendorBill, Vendor) showBillItems;
  final Function(VendorBill, Vendor, String,BusinessDetails?) printBill;
  final VendorBill vendorBill;
  final Vendor vendor;
  ...
  VendorBillActionDataCell({
    ...
    required this.vendorBill,
    required this.vendor,
    required this.businessDetails,
  });

  @override
  _VendorBillActionDataCellState createState() => _VendorBillActionDataCellState();
}

class _VendorBillActionDataCellState extends State<VendorBillActionDataCell> {
      ...
      children: [
        Tooltip(
          ...
          child: IconButton(
            ...
            onPressed: () => widget.onEdit(widget.vendorBill),
          ),
        ),
        Tooltip(
          message: 'Delete Bill',
          child: IconButton(
            ...
            onPressed: () => widget.onDelete(widget.vendorBill.id),
          ),
        ),
        Tooltip(
          ...
          child: IconButton(
            ...
            onPressed: () => widget.showBillItems(widget.vendorBill, widget.vendor),
          ),
        ),
        Tooltip(
          message: 'Print Bill',
          child: IconButton(
            ...
            onPressed: () => widget.printBill(widget.vendorBill, widget.vendor, widget.vendorBill.billType,widget.businessDetails),
          ),
        ),
      ],
    );
      ...
      children: [
        ...
        Tooltip(
          ...
          child: IconButton(
            ...
            onPressed: () => createRequestOnAction(context, widget.employeeId, widget.documentType, widget.vendorBill.id),
          ),
        ),
      ],
    );
