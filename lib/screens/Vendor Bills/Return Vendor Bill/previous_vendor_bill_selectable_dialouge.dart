...
class VendorBillSearchAndDetailsScreen extends StatefulWidget {
  final List<VendorBill> previousBills;
  final Function(List<Item>) onItemsSelected; // Updated callback function

  VendorBillSearchAndDetailsScreen({
    required this.previousBills,
    required this.onItemsSelected, // Receive callback in constructor
  });

  @override
  _VendorBillSearchAndDetailsScreenState createState() => _VendorBillSearchAndDetailsScreenState();
}

class _VendorBillSearchAndDetailsScreenState extends State<VendorBillSearchAndDetailsScreen> {
  TextEditingController _searchController = TextEditingController();
  List<VendorBill> _filteredBills = [];
  ...
  void _showVendorBillItems(VendorBill bill, Function(List<VendorBillItem>) onReturnBillItems) {
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: selectedItems.contains(true)
                              ? () {
                            List<VendorBillItem> selectedBillItems = [];
  ...
  void onReturnBillItems(List<VendorBillItem> selectedItems) {
    // Convert VendorBillItem to Item objects
    List<Item> convertedItems = selectedItems.map((billItem) {
      return Item(
        id: billItem.itemId,
        name: billItem.name,
        ...
        saleRate: billItem.purchaseRate,
    ...
    // Return the list of Item objects to the parent
    widget.onItemsSelected(convertedItems);
  }
                    ...
                    TableRow(
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              _showVendorBillItems(bill,onReturnBillItems);
                            },
                            child: Row(
