...
import 'edit_or_add_customer_return_bill.dart';



class MultiAddEditBillDialog extends StatefulWidget {
  final Bill? bill;
  final VoidCallback onBillSaved;

  const MultiAddEditBillDialog({Key? key, this.bill, required this.onBillSaved}) : super(key: key);

  @override
  _MultiAddEditBillDialogState createState() => _MultiAddEditBillDialogState();
}

class _MultiAddEditBillDialogState extends State<MultiAddEditBillDialog> {
  ...
  void _showMultiAddEditBillDialog([Bill? bill]) {
    showDialog(
      context: context,
      builder: (context) => MultiAddEditBillDialog(
        bill: bill,
        onBillSaved: (){},
      ),
    );
